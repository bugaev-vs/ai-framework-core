...
from typing import Any, Dict, Optional, List, Callable  # ⬅️ ДОБАВИТЬ Callable
import asyncio
...
class Chain(ABC):
    ...
    def __init__(self, verbose: bool = False):
        ...
        self._callbacks: List[Callable] = []  # ⬅️ ИСПРАВИТЬ: Callable вместо callable
    ...
    def add_callback(self, callback: Callable) -> None:  # ⬅️ ИСПРАВИТЬ: Callable вместо callable
