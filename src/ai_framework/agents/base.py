...
class SimpleAgent(Chain):  # ⬅️ ДОЛЖНО БЫТЬ SimpleAgent
...
"""
    ...
    def _select_tool(self, user_input: str) -> Optional[str]:
        ...
        math_keywords = ['calculate', 'compute', 'solve', 'math', 'equation', 'formula', '+', '-', '*', '/']
        ...
        search_keywords = [
            'search for', 'find information', 'look up', 'information about', 
            'what is', 'who is', 'tell me about', 'capital of', 'history of'
        ]
